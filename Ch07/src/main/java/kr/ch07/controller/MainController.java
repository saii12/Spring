...
public class MainController {
	...
	public String index(Model model) {
		...
		User1DTO user1 = new User1DTO("A101", "김춘추", "010-1234-1002", 23);
		...
		users.add(new User1DTO("A101", "김유신", "010-1111-1001", 25)); // User1DTO의 @AllArgsConstructor 활용
