...
@Log4j2
@Service
public class OAuth2UserService extends DefaultOAuth2UserService { // OAuth2UserService 로직이 제일 중요!

	@Autowired
	private UserRepository userRepository;
	
	@Override
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException { // 제일 마지막으로 리소스 서버에서 애플리케이션에 userRequest전달
		...
		return user; // 메서드 타입은 OAuth2USer, 리턴 타입은 Userentity라서 Userentity에서 implement 해줌
	}
